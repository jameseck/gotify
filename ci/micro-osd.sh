...
rbd create -p rbd testrbd1 --size=1024K
rbd create -p rbd testrbd2 --size=1024K
rbd create -p rbd testrbd3 --size=1024K
rbd lock add rbd/testrbd3 lockon3
rbd create -p rbd testrbd4 --size=1024K
rbd map -p rbd testrbd4
rbd create -p rbd testrbd5 --size=1024K
